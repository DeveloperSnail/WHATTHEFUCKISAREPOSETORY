...
/*
 * Metoda Files.newDirectoryStream može primiti filter 
 * 	kojim će preskakati određene datoteke
 * 	ovisno o specificiranom uvjetu filtera
 * */


public class IspisCijelogDirektorija_sFilteromBilj {
	...
	public static void listajDir(Path dir, int level) throws IOException {
		...
		DirectoryStream<Path> ds = Files.newDirectoryStream(dir, new FileFilter());
